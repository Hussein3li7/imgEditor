...
class CompImg extends StatefulWidget {
  @override
  _CompImgState createState() => new _CompImgState();
}

class _CompImgState extends State<CompImg> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> compress() async {
    final img = AssetImage("assets/img/img.jpg");
    print("pre compress");
      ...
      home: new Scaffold(
        ...
        body: ListView(
          children: <Widget>[
            AspectRatio(
              child: Image(
                image: provider ?? AssetImage("assets/img/img.jpg"),
            ...
            FlatButton(
              ...
              onPressed: () => testCompressAsset("assets/img/img.jpg"),
            ),
            FlatButton(
  ...
  Future compressListExample() async {
    final data = await rootBundle.load("assets/img/img.jpg");
