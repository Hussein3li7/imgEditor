...
class SharingFile extends StatefulWidget {
  @override
  _SharingFileState createState() => _SharingFileState();
}

class _SharingFileState extends State<SharingFile> {
  ...
  Future<void> initPlatformState() async {
    String platformVersion = Platform.version;
              ...
              RaisedButton(
                onPressed: () async {
                  await ImagePicker.platform
                      ...
                      .then((file) {
                    SocialShare.shareInstagramStory(file.path, "#eeeeee",
